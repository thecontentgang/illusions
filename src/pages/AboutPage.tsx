    ...
    <div className="bg-white pt-24 pb-12 overflow-hidden">
      ...
      <section className="py-12 md:py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          ...
          >
            ...
            <h3 className="relative z-10 text-3xl md:text-4xl font-abhre mb-6 leading-tight">
          ...
          >
            ...
            <h3 className="relative z-10 text-3xl md:text-4xl font-abhre  text-[#111827] mb-6 leading-tight">
      ...
      <section className="py-20 md:py-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 items-start lg:items-center justify-between">
          <div className="lg:w-1/3">
            ...
            <h3 className="text-4xl md:text-5xl font-abhre text-[#111827] leading-tight">
      ...
      <section className="py-12 md:py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <motion.a href="https://wa.me/918317503596" target="_blank" rel="noreferrer" whileHover={{ x: 10 }} className="inline-flex items-center gap-4 bg-[#1F2937] hover:bg-[#8B5CF6] text-white px-8 py-5 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] md:text-xs shadow-lg transition-all duration-300 group mt-4">
      ...
      <section className="px-6 py-16 md:py-24">
        ...
        >
          ...
          {/* Top Accent Glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-40 md:w-60 h-[3px] bg-[#8B5CF6] rounded-full shadow-[0_0_25px_rgba(196,181,253,0.7)]" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
            <Link to="/contact">
            <button className="w-full sm:w-auto px-8 md:px-10 py-4 bg-[#8B5CF6] text-white font-black uppercase tracking-[0.18em] text-[10px] md:text-xs rounded-2xl hover:shadow-[0_10px_30px_rgba(196,181,253,0.4)] hover:scale-[1.02] transition-all duration-300">
              Book Consultation
            </button>
            </Link>

            <Link to="/projects">
            <button className="w-full sm:w-auto px-8 md:px-10 py-4 border border-white/10 bg-white/5 backdrop-blur-sm text-white font-black uppercase tracking-[0.18em] text-[10px] md:text-xs rounded-2xl hover:border-[#8B5CF6]/60 hover:bg-white/10 transition-all duration-300">
              Explore Portfolio
            </button>
            </Link>
